...
const ROLES_ONGLETS: Record<string, string[]> = {
  admin:        ['calc','import','booking','retours','negatifs','commandes','commandes_attente','fournitures','inventaire','verification','comptabilite','amazon','aviseur','directeur_service','aviseur_technique','utilisateurs'],
  gestionnaire: ['calc','import','booking','retours','negatifs','commandes','commandes_attente','fournitures','inventaire','comptabilite','amazon','aviseur','directeur_service','aviseur_technique'],
  commis:       ['commandes','commandes_attente','fournitures','retours','aviseur'],
  employe_piece: ['commandes_attente','fournitures','negatifs','inventaire','retours','aviseur'],
}
